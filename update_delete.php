    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="nav navbar-nav">
                <a class="navbar-brand" href="admin_main_page.php">MITE OLX</a>
            </div>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="update_place.php?action=update&id=<?php echo $row["name"]; ?>"><span class="text-danger"><i class="fas fa-pencil fa fa-2x"></i></span></a></td>
